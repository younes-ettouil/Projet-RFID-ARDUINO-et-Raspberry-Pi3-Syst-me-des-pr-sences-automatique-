            ...
            <div class="row1-container">
                <div class="box blue">
                    <div style="display: flex;">
                        ...
                        <a class="btn btn-outline-primary" href="../g-enseignants/create.php" style="height: 65px;">Ajouter Enseignant</a>
                    ...
                    $sql = "select personne.id ,personne.rfid_id, personne.Nom,personne.Prenom,rfid.rfid ,semestre.nomSemestre from personne join semestre JOIN rfid where personne.Role like 'enseignant' and personne.idSemestre = semestre.id AND personne.rfid_id = rfid.id";
                    if ($result = mysqli_query($link, $sql)) {
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                echo '<a href="delete.php?id=' . $row['id'] . '&id2=' . $row['rfid_id'] . '" title="supprimer" data-toggle="tooltip" style="color:red;"><span class="fa fa-trash"></span></a>';
                                echo "</td>";
                                echo "</tr>";
                            }
                            echo "</tbody>";
