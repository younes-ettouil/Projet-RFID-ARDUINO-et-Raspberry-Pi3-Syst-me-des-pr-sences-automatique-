        ...
        <div class="container">
            ...
            <div class="row1-container">
                <div class="box blue">
                    ...
                    $sql = "SELECT presence.date,module.nomModule from presence JOIN module where presence.idPersonne = ? and presence.idModule = module.id";
                    ...
                    echo"<a href='list.php' class='btn btn-outline-primary '>retour</a>";
                    // Close connection
                    mysqli_close($link);
