...
<body>
    ...
    <?php
    // include '../config.php';
    $query="select * from rfid"; // Fetch all the data from the table customers
    $query2="select * from semestre"; // Fetch all the data from the table customers
            ...
            <div class="container" style="margin-top: -10px;">
                <div class="row justify-content-center">
                    <div class="col-md-6 text-center mb-2">
                        <h2 class="heading-section">Ajouter etudiant</h2>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-md-7 col-lg-5">
                        <div class="login-wrap p-4 p-md-5">
                            ...
                            <h3 class="text-center mb-4">Infromations d'etudiant</h3>
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                ...
                                <div class="form-group">
                                    <input type="hidden" name="role" class="form-control <?php echo (!empty($role_err)) ? 'is-invalid' : ''; ?>" value="etudiant">
                                </div>
