        ...
        <div class="container">
            ...
            <div class="row1-container">
                <div class="box blue">
                    ...
                    $sql = "SELECT presence.date , personne.Nom,personne.Prenom , personne.Role , module.nomModule FROM presence JOIN personne JOIN module WHERE presence.idPersonne = personne.id AND presence.idModule = module.id AND  presence.idModule = ? AND SUBSTRING(presence.date, 1, 10) like ?  AND personne.role like 'enseignant'";
