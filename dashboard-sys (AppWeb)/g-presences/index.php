            ...
            <div class="row1-container">
                <div class="box blue">
                    <div style="display: flex; justify-content: center;">
                        <a href="listpresences.ens.php" class=" text-center" style="text-decoration: none; color:#549EF2">
                            <h6>liste des presences des enseignants</h6>
                            <img src="https://cdn-icons-png.flaticon.com/512/3750/3750020.png" width="90px" alt="">
                        </a>
                        <a href="listpresences.etu.php" class=" text-center" style="margin-left: 50px;text-decoration: none; color:#549EF2">
                            <h6>liste des presences des etudiants</h6>
                            <img src="https://cdn-icons-png.flaticon.com/512/3135/3135810.png" width="90px" alt="">
                        </a>

                    </div>
                    <a href='../index.php' class='btn btn-outline-primary ' style="margin-top: 30px;">retour</a>
